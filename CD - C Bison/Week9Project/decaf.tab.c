...
#line 152 "decaf.tab.c" /* yacc.c:358  */
...
{
       0,    41,    41,    43,    44,    46,    48,    49,    51,    52,
      53,    56,    57,    59,    60,    62,    63,    65,    66,    68,
     ...
     137,   138,   139,   141,   142,   144,   145,   148,   149,   150
};
#endif
...
yyin = fopen("a.txt", "r");
yyparse();
printf("Program succesfully compiled");
