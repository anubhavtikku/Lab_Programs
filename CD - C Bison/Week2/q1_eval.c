/*	Cases handled: Arithmetic, Logical, Relational, Bitwise, Special, Bracket
				   Numerical constants, String literals, Unary, Assignment,
				   EOF, Keywords, Identifiers*/
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <ctype.h>
...
void retract(FILE* fp){		//Move file pointer one step back
